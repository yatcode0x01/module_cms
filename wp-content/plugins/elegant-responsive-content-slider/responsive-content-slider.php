...
/*  Copyright 2017  Realwebcare  (email : realwebcare@gmail.com)
...
function ercs_admin_adding_style() {
	wp_register_script( 'ercs-admin', plugin_dir_url( __FILE__ ) . '/assets/js/ercs-admin.min.js', '1.0.1', true );
	...
	wp_enqueue_style( 'ercs_admin_style', plugins_url('/assets/css/ercs-admin.css', __FILE__),'','1.0.1', false );
}
